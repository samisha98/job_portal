...
<head>
  ...
  <link rel="stylesheet" href="view-job-post.css">
        ...
        <div class="row">          
          <div class="col-md-6 bg-white padding-2">
            <div class="pull-left">
              ...
              <a href="index.php" class="btn btn-default btn-sm btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
